...
namespace itl2
{
	...
	namespace tests
	{
		void pathopening2d()
		{
			...
			draw(orig, Capsule<double>(Vec3d(10, 10, 0), Vec3d(70, 70, 0), 5), (uint8_t)255);
			draw(orig, Capsule<double>(Vec3d(20, 80, 0), Vec3d(50, 50, 0), 8), (uint8_t)255);
			...
			// Save results
			raw::writed(orig, "./pathopening/orig2d");
			raw::writed(length, "./pathopening/length2d");
		}
